...
TEST(MD5_to_hex_string, AllZeros) {
    // GIVEN
    hash::MD5Hash hash = {0, 0, 0, 0};

    // WHEN
    auto result = hash::to_hex_string(hash);
...
TEST(MD5_to_hex_string, FirstNibble) {
    // GIVEN
    hash::MD5Hash hash = {0x30201000, 0x70605040, 0xb0a09080, 0xf0e0d0c0};
...
TEST(MD5_to_hex_string, SecondNibble) {
    // GIVEN
    hash::MD5Hash hash = {0x03020100, 0x07060504, 0x0b0a0908, 0x0f0e0d0c};
