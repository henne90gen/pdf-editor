...
class MainWindow : public Gtk::ApplicationWindow {
  public:
    MainWindow(BaseObjectType *obj, Glib::RefPtr<Gtk::Builder> _builder)
        ...
        targets = {Gtk::TargetEntry("text/uri-list")};
        this->drag_dest_set(targets, Gtk::DEST_DEFAULT_DROP | Gtk::DEST_DEFAULT_HIGHLIGHT | Gtk::DEST_DEFAULT_MOTION,
                            Gdk::ACTION_COPY | Gdk::ACTION_MOVE);
        this->signal_drag_drop().connect(sigc::mem_fun(this, &MainWindow::on_drag_drop));
        this->signal_drag_data_received().connect(sigc::mem_fun(this, &MainWindow::on_drag_data_received));
    }
